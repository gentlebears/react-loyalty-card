...
import qr2 from '../assets/qr/qr-code2.png';
...
const Qr = () => {
	...
	return (
		...
		<div className='max-w-xl h-screen2 text-center font-buttonfont self-center items-center mx-auto grid gap-y-5 py-4 px-5'>
