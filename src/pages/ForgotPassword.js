...
export default function ForgotPassword() {
	...
	return (
		<form
			...
			className="max-w-xl h-screen2 content-center self-center items-center mx-auto grid gap-y-px py-4 px-5"
		>
			<motion.div
