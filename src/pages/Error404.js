...
const Error404 = () => {
	...
	return (
		<div className='max-w-xl h-screen2 text-center font-buttonfont content-center self-center items-center mx-auto grid gap-y-5 py-4 px-5'>
			...
			<div className='bg-zinc-900 text-white w-auto my-auto mx-auto py-10 px-9 sm:px-28 sm:py-10 text-2xl'>Opps! Sayfa bulunamadı</div>
			<div className=''>Aradığınız sayfa mevcut değil. Adresi yanlış yazmış olabilirsiniz veya sayfa taşınmış olabilir.</div>
			<div>
				<button
					type='submit'
