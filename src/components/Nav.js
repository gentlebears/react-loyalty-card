...
const Nav = () => {
	...
	return (
		<div className="shadow-md w-full relative z-50 top-0 left-0 hidden sm:block ">
			<div className="md:flex items-center justify-between dark:bg-zinc-900 bg-white py-4 md:px-10 px-7 transition-all duration-200 ease-in h-[10vh]">
				<Link to={"/"}>
				...
				<div className="flex">
					<ul
						className={`h-[10vh] md:flex md:items-center md:pb-0 pb-12 absolute md:static dark:bg-zinc-900 bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-200 ease-in ${
